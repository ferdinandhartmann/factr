...
def load_vit(model_name="SOUP_1M_DH", device=torch.device("cuda:0"), in_chans=3):
    _check_and_download()
    model = vit.vit_base_patch16(img_size=224, use_cls=True, drop_path_rate=0.0, in_chans=in_chans)
