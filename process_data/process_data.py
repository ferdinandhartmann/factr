...
def main(cfg: DictConfig):
    ...
    state_topic_specs = {
        ...
        "/franka_robot_state_broadcaster/external_wrench_in_stiffness_frame": {"keys": ["external_wrench"], "dim": 6, "fallback": None},
    }
    ...
    for episode_pkl in pbar:
        ...
        if state_topic_dims is None:
            ...
            if episode_dims != state_topic_dims:
                raise ValueError("State topic dimensions changed across episodes; cannot build consistent normalization stats.")
